package com.buffalo.controlefinancas.util.calendario.widget;
...
import com.buffalo.controlefinancas.util.calendario.data.CalendarAdapter;
...
import com.buffalo.controlefinancas.util.calendario.view.ExpandIconView;
...
//                }
    ...
    public void addEventTag(List<Event> events) {
        mEventList.addAll(events);
        mAdapter.addEvent(events);
        reload();
    }
